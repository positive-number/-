...
class Limo_wall_following:
    def __init__(self, direction):
        ...
        self.speed_pub = rospy.Publisher("limo/wall_speed", Float32, queue_size=3)
        self.angle_pub = rospy.Publisher("limo/wall_angle", Float32, queue_size=3)
        ...
        self.default_speed = 0.26
        self.default_angle = 0.6
        self.scan_dist = 0.3
        self.offset = 0.02
